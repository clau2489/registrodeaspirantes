    ...
    <div class="container">
      <div class="row"> 
          <div class="offset-md-3 col-md-6 p2 text-center">
            ...
            <br>
            <br>
            <h4 class="alert-heading">No se ha podido completar su solicitud</h4>
            <br>
          </div>
        </div>
        <div class="row">
          <div class="offset-md-3 col-md-6">
            <div class="text-center alert alert-danger" role="alert">
              <h3 class="alert-heading">El DNI ingresado ya posee una solicitud como BENEFICIARIO en el Registro Único de Aspirantes a Programas Habitacionales del Municipio de Marcos Paz.</h3>
            </div>
            <br>
          </div>
          <div class="offset-md-3 col-md-6">
